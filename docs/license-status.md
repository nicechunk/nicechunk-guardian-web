# nicechunk-guardian-web License Status

nicechunk-guardian-web does not currently publish a public open-source license file.
...
Before a public open-source release, the owner should choose whether nicechunk-guardian-web uses the same license as the wider NiceChunk repository set or needs repository-specific terms.
